  ...
  return (
    <div>
      <div className="flex flex-col z-30 justify-center items-center sticky top-0">
        <header className='mt-2 rounded-full w-[22rem] md:w-[45rem] lg:w-[65rem] bg-gray-200
          ...
          <nav className='flex items-center gap-5 justify-between'>
            ...
            <Link to={'/create'} className='text-center text-[0.9rem] font-semibold w-[7.5rem]
                py-[0.5rem] md:w-[9rem] bg-green-400'>
                Create New post
              </Link>  
              <Link onClick={logout} className='text-center font-semibold 
